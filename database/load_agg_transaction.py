...
# === 1) EDIT THESE ===
CSV_PATH   = "/Users/kishore_kumar/PhonePe/pulse/csv_out/aggregated_transactions.csv"  # <- put your CSV path here
DB_USER    = "root"
DB_PASS    = "Root@123"        # special chars handled
DB_HOST    = "localhost"
DB_PORT    = 3306
DB_NAME    = "phonepe_pulse"   # database must exist (or see Step 3b below)
TABLE_NAME = "aggregated_transaction"       # name you want in MySQL
